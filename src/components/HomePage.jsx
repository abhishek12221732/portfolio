...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      {/* Navigation Bar */}
      <Meteors 
  meteorColor="bg-gradient-to-r from-indigo-600 to-blue-600" // Custom head color
  tailColor="bg-gradient-to-r from-indigo-400 to-transparent" // Custom tail color
/>
    ...
    Abhishek Kumar Yadav
            ...
            I build intelligent web solutions combining cutting-edge technologies with 
            user-centered design. Currently pursuing Computer Science at LPU.
            </p>
      ...
      >
        {[
          { icon: <FiGithub size={24} />, url: "https://github.com/abhishek12221732" },
          { icon: <FiLinkedin size={24} />, url: "https://www.linkedin.com/in/abhishekkumar1732/" },
