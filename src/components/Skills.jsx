  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: "JavaScript", icon: <SiJavascript size={20} />, level: 4 },
        { name: "Python", icon: <SiPython size={20} />, level: 4 },
        { name: "Java", icon: <FaJava size={20} />, level: 3 }, // Changed to FaJava
        { name: "C++", icon: <SiCplusplus size={20} />, level: 3 },
      ]
    },
    {
      title: "Frontend",
      ...
      skills: [
        { name: "React", icon: <SiReact size={20} />, level: 4 },
        { name: "Next.js", icon: <SiNextdotjs size={20} />, level: 3 },
        { name: "Tailwind", icon: <SiTailwindcss size={20} />, level: 4 },
        { name: "Flutter", icon: <SiFlutter size={20} />, level: 3 },
      ]
    },
    {
      title: "Backend",
      ...
      skills: [
        { name: "Node.js", icon: <SiNodedotjs size={20} />, level: 4 },
        { name: "Express", icon: <span className="text-lg font-bold">EX</span>, level: 3 },
      ]
    },
    {
